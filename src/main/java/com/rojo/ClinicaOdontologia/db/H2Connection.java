...
public class H2Connection {
    ...
    private final static String DB_URL = "jdbc:h2:./ClinicaOdontologicaDB";
    ...
    public static void crearTablas() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:h2:./ClinicaOdontologicaDB;INIT=RUNSCRIPT FROM 'CrearTablasBD.sql'", "sa", "sa");
        } catch (Exception e) {
            e.printStackTrace();
